...
* User and password will be automatically added to auto generated userlist.txt for MD5 Auth
...
Almost all settings found in the [pgbouncer.ini](https://pgbouncer.github.io/config.html) can be defined as environment variables, except a few that make little sense in a Docker environment (like port numbers, syslog and pid settings). See the [entrypoint script](https://github.com/KirksFletcher/pgbouncer-docker/blob/master/entrypoint.sh) for details. For example:
...
For example in Kubernetes, see the [examples/kubernetes folder](https://github.com/KirksFletcher/pgbouncer-docker/tree/master/examples/kubernetes).


Docker Compose
--------------

For example in Docker Compose, see the [examples/docker-compose folder](https://github.com/KirksFletcher/pgbouncer-docker/tree/master/examples/docker-compose).
...
Use [examples/generate-userlist](https://github.com/KirksFletcher/pgbouncer-docker/blob/master/examples/generate-userlist) to generate this file:
